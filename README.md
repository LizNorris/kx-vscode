...
!!!note "For kdb Insights Enterprise free trial instances"
   The realm is configured as `insights-{URLcode}` where {URLcode} is the 10 digit code in the trial URL. For example: if your trial url is https://fstc83yi5b.ft1.cld.kx.com/ the realm should be `insights-fstc83yi5b`.
